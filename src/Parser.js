...
const { NumberNode, BinaryOperatorNode, UnaryOperatorNode, VarAccessNode, VarAssignmentNode, StringNode } = require("./Node");
...
class Parser{
    ...
    expression(){
        ...
        let node = res.register(this.BinaryOperator(this.term, [TT_PLUS, TT_MINUS]));
